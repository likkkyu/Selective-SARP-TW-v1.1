...
| 2026-07-28 | N25/N50/N100/N200 | Gurobi subset probe（distance+cost） | dir=`outputs_cmp/gurobi_subset_20260727_233916`; logs=`logs/gurobi_subset_20260727_233916`; summary=`outputs_cmp/GUROBI_SUBSET_20260727_233916_SUMMARY.md`; seed=99999; samples=`N25=20,N50=10,N100=1,N200=1` | - | - | - | - | - | 可行性边界证据：N25 可行率约 `16/20`，N50/N100/N200 在本批次均 `num_feasible=0`（`avg_cost=inf`）。可用于说明 strict 模式下 Gurobi 大规模覆盖困难，但不用于主表统计结论。 |
